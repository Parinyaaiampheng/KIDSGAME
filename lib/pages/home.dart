    ...
    return DragTarget<String>(
      ...
      onAccept: (data) {
        setState(() {
          ...
          if (score.values.where((element) => element).length == choices.length) {
      // หากมีการลากไอคอนไปยังกล่องที่ถูกต้องทั้งหมด
      // ทำอะไรก็ตามที่คุณต้องการทำ เช่น แสดง AlertDialog, เริ่มเกมใหม่, ฯลฯ
    }
        });
      },
      onLeave: (data) {},
